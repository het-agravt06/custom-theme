...
;(function($) {
	...
	$(function() {
	 ...
	 /* ============== Quantity buttons ============== */
		...
		if( $('#the8-shop-product-list').length ){
			
			$( 'body' ).on( 'click', '#the8-shop-product-list', function(e) {
				 e.preventDefault();
				 $(this).addClass('active');
				 $('ul.products li').removeClass('grid');
				 $('#the8-shop-product-grid').removeClass('active');
				 $('ul.products li').addClass('do-to-list');
				
			});
		}

		if( $('#the8-shop-product-grid').length ){
			
			$( 'body' ).on( 'click', '#the8-shop-product-grid', function(e) {
				 e.preventDefault();
				 $(this).addClass('active');
				 $('#the8-shop-product-list').removeClass('active');
