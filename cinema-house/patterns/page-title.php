...
/**
 * Title: Page Title
 * Slug: cinema-house/page-title
 * Categories: cinema-house, page-title
 */
?>
...
<div class="wp-block-group alignwide"><!-- wp:post-title {"textAlign":"center","className":"wow slideInDown","style":{"typography":{"textTransform":"uppercase","letterSpacing":"1px","fontSize":"35px"}},"textColor":"white"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->